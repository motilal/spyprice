...
if ($pages > 1 || $alwaysShowPagination === true) {
    ...
    <ul class="<?= implode(' ', $classes) ?>">
        ...
        ?>
        <li class="<?= implode(' ', $classes) ?>"><a  data-pagenumber="<?php echo isset($params['page']) ? $params['page'] : ''; ?>" href="<?= ($href) ?>"><?= ($previous) ?></a></li>
        <?php
        /**
        ...
        if ($clean === false) {
            ...
            ?>
        <li class="<?= implode(' ', $classes) ?>"><a data-pagenumber="<?php echo isset($params['page']) ? $params['page'] : ''; ?>" href="<?= ($href) ?>"><?= ($next) ?></a></li>
    </ul>
    <?php
}
